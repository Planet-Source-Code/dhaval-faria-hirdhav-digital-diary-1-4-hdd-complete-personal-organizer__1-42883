...
Begin VB.Form frmARDetail 
   BorderStyle     =   0  'None
   Caption         =   "Hirdhav Digital Diary - Detail Anivarsary Reminder Details"
   ClientHeight    =   4095
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   5175
   ...
   Begin VB.Label lblCaption 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Hirdhav Digital Diary  -  Detail Anivarsary Reminder"
      Height          =   225
      Left            =   195
      TabIndex        =   5
      Top             =   15
