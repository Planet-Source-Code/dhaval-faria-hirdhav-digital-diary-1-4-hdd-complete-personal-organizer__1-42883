...
Begin VB.Form frmNewScheduler 
   BorderStyle     =   0  'None
   Caption         =   "Hirdhav Digital Dairy - New Schedule"
   ClientHeight    =   4575
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4950
   ...
   Begin VB.Label lblCaption 
      AutoSize        =   -1  'True
      BackStyle       =   0  'Transparent
      Caption         =   "Hirdhav Digital Diary  -  New Schedule"
      Height          =   225
      Left            =   195
      TabIndex        =   0
      Top             =   15
   ...
   End
End
Attribute VB_Name = "frmNewScheduler"
...
txtTo.BackColor = RGB(145, 155, 100)
...
HDDMsgBox "Schedule inserted successfully."
