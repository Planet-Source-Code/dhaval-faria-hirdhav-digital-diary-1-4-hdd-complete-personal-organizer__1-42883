...
Begin VB.Form frmNewAR 
   BorderStyle     =   0  'None
   Caption         =   "Hirdhav Digital Diary - New Anivarsary Reminder"
   ClientHeight    =   4575
   ClientLeft      =   0
   ClientTop       =   0
   ClientWidth     =   4950
...
HDDMsgBox "Anivarsary Reminder inserted successfully."
